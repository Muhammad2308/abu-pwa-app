          ...
          <div className="relative z-10">
            ...
            <div className="w-full mb-4">
              <div className="flex h-2.5 rounded-full overflow-hidden bg-white bg-opacity-20 border border-white border-opacity-30 shadow-inner">
                {/* Tier 1: 1 - 100,000 */}
                <div className={`flex-1 transition-colors duration-300 ${(isAuthenticated && user && totalDonated >= 1) ? 'bg-white bg-opacity-40' : 'bg-white bg-opacity-10'
                  }`}></div>
                {/* Tier 2: 100,000 - 999,999 */}
                <div className={`flex-1 transition-colors duration-300 ${(isAuthenticated && user && totalDonated >= 100000) ? 'bg-orange-300 bg-opacity-80' : 'bg-white bg-opacity-10'
                  }`}></div>
                {/* Tier 3: 1,000,000+ */}
                <div className={`flex-1 transition-colors duration-300 ${(isAuthenticated && user && totalDonated >= 1000000) ? 'bg-green-300 bg-opacity-90' : 'bg-white bg-opacity-10'
                  }`}></div>
              </div>
              {/* Tier labels */}
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start gap-4">
                          {/* Icon */}
                          <div className={`w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 ${isProject ? 'bg-gradient-to-br from-purple-100 to-purple-200' : 'bg-gradient-to-br from-blue-100 to-blue-200'
                            }`}>
                            {isProject ? (
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between gap-2 mb-2">
                              ...
                              <div className="text-right flex-shrink-0">
                                ...
                                <div className={`text-xs px-2.5 py-1 rounded-full font-semibold inline-block ${isSuccess
